...
model.initialize_pose="zero" model.model_change=False data.h=256 data.w=256 model.use_cubemap=True fp16=True training.scheduler=True model.add_fake_movement=False training.set_global_time_step=True training.lr=0.05 training.guidance_scale=100
